...
banner = pyfiglet.figlet_format("Dir Killer",font="contessa")
...
for i in mylist:
    ...
    if http.status_code==200:
        print("\n"+Fore.GREEN+" [+] "+Fore.WHITE+f)
        with open ("truelist.txt","a+") as ta:
            ta.write(f"{url}/{i}\n")
    else:
        print("\n"+Fore.RED+" [-] "+Fore.YELLOW+f+"\n")
